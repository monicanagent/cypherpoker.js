...
async function CP_SmartContract(sessionObj) {
   ...
   switch (requestParams.action) {
      case "new":
         ...
         console.log(
            " 1line 113 cypherpokercontactvalidContractObject...",
         ...
         try {
            console.log(
               " 1line 127 cypherpokercontact Validating account...",
               requestParams.account
            );
            var playerAccount = await validAccount(requestParams.account);
            console.log(
               "line 142 cypherpokercontact playerAccount...",
               playerAccount
            );
         } catch (err) {
            console.log("line 144 playerAccount...", err.message);
            sendError(
               JSONRPC_ERRORS.ACTION_DISALLOWED,
               err.message,
               sessionObj
